...
(function (factory) {
  ...
  var dialog = renderer.create('<div class="modal" id="summerNoteModal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    if (options.fade) {
      $node.addClass('fade');
    }
    $node.html([
      ...
      '    </div>' : ''
        ...
        '    <div class="modal-body"><div class="row" style="margin-right: -0px;margin-left: 0px;"><div class="col-md-12">' + options.body + '</div></div></div>',
      (options.footer ?
